    ...
    <a
      href={
        ...
        (props.message
          ...
          : encodeURI(
              "Have you seen the Tax Foundation's 2018 State Business Tax Climate Index? Check it out here:"
            )) +
...
const IconEmail = props => {
  let emailSubject =
    props.emailSubject || 'Check out the State Business Tax Climate Index';
  let emailBody =
    props.emailBody ||
    `You can see it here: ${encodeURI(window.location.href)}`;
  return (
