  ...
  return (
    <div className="sbtci-box sbtci-state-share-box">
      ...
      <div className="sbtci-state-share-box-buttons">
        <IconFacebook className="sbtci-social--facebook sbtci-state-share-box-button" fill="#ffffff" text="Share" />
        <IconTwitter className="sbtci-social--twitter sbtci-state-share-box-button" fill="#ffffff" text="Tweet" />
      </div>
    </div>
  );
}
